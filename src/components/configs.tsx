    ...
    <div className="fixed right-6 bottom-6 z-10 md:right-3 md:bottom-3 lg:right-4 lg:bottom-4 2xl:right-6 2xl:bottom-6">
      <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
        <DialogTrigger asChild>
          <button className="cursor-pointer rounded-full bg-white p-3 text-gray-600 shadow-lg backdrop-blur-sm transition-colors hover:bg-gray-100 hover:text-gray-800 md:p-1.5 lg:p-2 2xl:p-3 dark:bg-gray-800/80 dark:text-gray-300 dark:hover:bg-gray-800/90 dark:hover:text-white">
